...
public class ProjectController {
    ...
    public JSONObject euProjectID( //
            ...
            throws Exception {
        String queryCheck = "ASK  { <"+id+"> <https://linkedopendata.eu/prop/direct/P35> <https://linkedopendata.eu/entity/Q9934> }";
        System.out.println(queryCheck);
        TupleQueryResult checkSet = sparqlQueryService.executeAndCacheQuery(sparqlEndpoint, queryCheck, 2, false);
        System.out.println(checkSet.next());
        String query =
...
//                    + " ?blank <https://linkedopendata.eu/prop/qualifier/P836> ?summary . "
    ...
    public ResponseEntity euSearchProject( //
        ...
        for (int i = inputOffset; i < inputOffset+inputLimit -1; i++) {
